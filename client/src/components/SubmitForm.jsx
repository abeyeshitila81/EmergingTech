    ...
    <div className="max-w-xl mx-auto">
      ...
      <div className="backdrop-blur-2xl bg-white/5 p-10 rounded-[2.5rem] border border-white/10 shadow-3xl relative overflow-hidden group animate-in fade-in zoom-in-95 duration-500">
        ...
        <form onSubmit={handleAddResult} className="relative z-10 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-bold text-fuchsia-400 uppercase tracking-widest mb-2 ml-1 flex justify-between">
                <span>Mid Exam</span>
                <span className="opacity-50 text-[10px]">/ 30</span>
              </label>
              <input
                type="number"
                max="30"
            ...
            <div>
              <label className="block text-xs font-bold text-emerald-400 uppercase tracking-widest mb-2 ml-1 flex justify-between">
                <span>Final Exam</span>
                <span className="opacity-50 text-[10px]">/ 40</span>
              </label>
              <input
                type="number"
                max="40"
                min="0"
                className="w-full bg-slate-900/50 border border-slate-800 rounded-2xl px-5 py-4 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all font-medium"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-bold text-amber-400 uppercase tracking-widest mb-2 ml-1 flex justify-between">
                <span>Quiz / Attend</span>
              ...
              <input
                ...
                max="10"
                min="0"
                className="w-full bg-slate-900/50 border border-slate-800 rounded-2xl px-5 py-4 text-white focus:outline-none focus:ring-2 focus:ring-amber-500/30 transition-all font-medium"
                value={newStudent.quiz}
                onChange={(e) => setNewStudent({...newStudent, quiz: e.target.value})}
              />
            </div>
            <div>
              <label className="block text-xs font-bold text-cyan-400 uppercase tracking-widest mb-2 ml-1 flex justify-between">
                <span>Assignment</span>
                <span className="opacity-50 text-[10px]">/ 20</span>
              </label>
              <input
                type="number"
                max="20"
                min="0"
                className="w-full bg-slate-900/50 border border-slate-800 rounded-2xl px-5 py-4 text-white focus:outline-none focus:ring-2 focus:ring-cyan-500/30 transition-all font-medium"
