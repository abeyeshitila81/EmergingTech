            ...
            <tbody className="divide-y divide-white/5">
              {resultsList.map((item, index) => (
                <tr key={item._id} className="hover:bg-white/5 transition-colors group">
                  ...
                  <td className="px-6 py-4 text-center">
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button 
                        onClick={() => onEdit(item)}
                        title="Edit Record"
                        className="p-2 bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 rounded-lg border border-blue-500/20 transition-all hover:scale-105"
                      >
