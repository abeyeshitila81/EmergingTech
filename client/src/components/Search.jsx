            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-slate-900/40 p-4 rounded-2xl border border-white/5 flex flex-col items-center">
                  <span className="text-[10px] font-black text-fuchsia-400 uppercase tracking-widest mb-1 text-center">Mid Exam</span>
                  <span className="text-xl font-bold text-white">{result.mid_exam ?? '---'}<span className="text-[10px] text-slate-500 ml-0.5 font-bold">/30</span></span>
                </div>
                <div className="bg-slate-900/40 p-4 rounded-2xl border border-white/5 flex flex-col items-center">
                  <span className="text-[10px] font-black text-emerald-400 uppercase tracking-widest mb-1 text-center">Final Exam</span>
                  <span className="text-xl font-bold text-white">{result.final_exam !== null ? result.final_exam : '---'}<span className="text-[10px] text-slate-500 ml-0.5 font-bold">/40</span></span>
                </div>
                <div className="bg-slate-900/40 p-4 rounded-2xl border border-white/5 flex flex-col items-center">
                  <span className="text-[10px] font-black text-amber-400 uppercase tracking-widest mb-1 text-center">Quiz</span>
                  <span className="text-xl font-bold text-white">{result.quiz ?? '---'}<span className="text-[10px] text-slate-500 ml-0.5 font-bold">/10</span></span>
                </div>
                <div className="bg-slate-900/40 p-4 rounded-2xl border border-white/5 flex flex-col items-center">
                  <span className="text-[10px] font-black text-cyan-400 uppercase tracking-widest mb-1 text-center">Assignment</span>
                  <span className="text-xl font-bold text-white">{result.assignment ?? '---'}<span className="text-[10px] text-slate-500 ml-0.5 font-bold">/20</span></span>
                </div>
              </div>
